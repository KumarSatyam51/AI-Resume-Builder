...
const Footer = () => {
  return (
    <>
            ...
            <footer className="flex flex-wrap justify-center lg:justify-between overflow-hidden gap-10 md:gap-20 py-16 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-green-700 bg-black">
                <div className="flex flex-wrap items-start gap-10 md:gap-[60px] xl:gap-[140px]">
                    <div>
         <h1 className="text-3xl font-extrabold text-green-700 tracking-wide">
  Resume<span className="text-white">.</span>
</h1>
         </div>
                ...
                <div className="flex flex-col max-md:items-center max-md:text-center gap-2 items-end">
                    ...
                    <p className="mt-3 text-center">© 2026 <a>NextCV</a></p>
                </div>
            </footer>
        </>
  );
