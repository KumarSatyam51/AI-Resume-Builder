...
const Hero = () => {
  ...
  return (
    <>
      ...
      <section className="relative flex flex-col items-center bg-black text-white text-sm pb-10  bg-top bg-no-repeat">
  ...
  Resume<span className="text-white">.</span>
          ...
          <div className="hidden md:flex items-center gap-8 transition duration-500 border border-green-900 bg-green-950 px-10 py-3 rounded-full">
              <a href="#" className="text-sm text-slate-50 hover:text-green-600 transition">Home</a>
              <a href="#features" className="text-sm text-slate-50 hover:text-green-600 transition">Features</a>
              <a href="#testimonials" className="text-sm text-slate-50 hover:text-green-600 transition">Testimonials</a>
              <a href="#cta" className="text-sm text-slate-50 hover:text-green-600 transition">Contact</a>
          </div>
          ...
          <div className="flex gap-2">
            ...
            <Link
              to="/app?state=login"
              className="hidden md:block px-6 py-2 border active:scale-95 hover:bg-slate-50 transition-all rounded-full text-white-700 hover:text-green-900"
            >
              Login
            </Link>
          </div>
        ...
        {/* --------Mobile Navbar ------------ */}
        <div id="mobile-navLinks" aria-hidden={!mobileOpen} className={`fixed inset-0 z-100 bg-black/60 backdrop-blur flex flex-col items-center justify-center text-lg gap-8 md:hidden transition-transform duration-300 ${mobileOpen ? 'translate-x-0' : '-translate-x-full'}`}>
     ...
     {/* Hero Section */}
        ...
        <p className="max-w-md text-center text-base my-7">
           Create, edit and downdload professional resumes with AI-powered assistance.
          </p>
        ...
        {/* CTA Buttons */}
                  <div className="flex items-center gap-4 ">
                    ...
                    <button className="flex items-center gap-2 border border-slate-400 hover:bg-green-700 transition rounded-full px-7 h-12 text-white">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                        height="24"
